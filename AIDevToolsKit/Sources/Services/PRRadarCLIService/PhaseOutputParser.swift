...
public enum PhaseOutputParser {
    ...
    public static func loadPRDiff(
        ...
        try? parsePhaseOutput(
            ...
            filename: PRRadarPhasePaths.prDiffFilename, commitHash: commitHash
        )
    }
    ...
    public static func loadEffectiveDiff(
        ...
        try? parsePhaseOutput(
            config: config, prNumber: prNumber, phase: .diff,
            filename: PRRadarPhasePaths.effectiveDiffParsedJSONFilename, commitHash: commitHash
        )
    }
    ...
    public static func listRulesFiles(
        ...
        listPhaseFiles(config: config, prNumber: prNumber, phase: .prepare, subdirectory: PRRadarPhasePaths.prepareRulesSubdir, commitHash: commitHash)
