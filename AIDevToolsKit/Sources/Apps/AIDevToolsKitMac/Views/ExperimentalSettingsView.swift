        ...
        Form {
            ...
            Section("AI Providers") {
                Toggle("Anthropic API", isOn: Binding(
                    ...
                    set: { experimentalSettings.updateAnthropicAPIEnabled($0) }
                ))
                ...
                Toggle("Codex", isOn: Binding(
                    ...
                    set: { experimentalSettings.updateCodexEnabled($0) }
                ))
            ...
            Section("Features") {
                Toggle("Architecture Planner", isOn: Binding(
                    ...
                    set: { experimentalSettings.updateArchitecturePlannerEnabled($0) }
                ))
