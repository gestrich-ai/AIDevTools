...
struct AIDevToolsKit: AsyncParsableCommand {
    ...
    private static var subcommandTypes: [any ParsableCommand.Type] {
        var commands: [any ParsableCommand.Type] = [
            ChatCommand.self, ClaudeChainCLI.self, ConfigCommand.self, CredentialsCommand.self, EvalsCommand.self, LogsCommand.self, MCPCommand.self, PlanCommand.self, PRRadarCommand.self, ReposCommand.self, SkillsCommand.self, SweepCommand.self, WorktreeCommand.self,
        ]
