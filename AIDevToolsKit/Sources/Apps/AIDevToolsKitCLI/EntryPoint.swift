...
struct AIDevToolsKit: AsyncParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        subcommands: [ChatCommand.self, ClaudeChatCommand.self, ClearArtifactsCommand.self, ListCasesCommand.self, PlanRunnerCommand.self, ReposCommand.self, RunEvalsCommand.self, ShowOutputCommand.self, SkillsCommand.self]
    )
