...
struct PhaseBehaviorTests {
    ...
    func phaseDirectoryMetadata() {
        let dir = PRRadarPhasePaths.phaseDirectory(
            outputDir: "/output",
            prNumber: 42,
            phase: .metadata
        )
    ...
    func metadataDirectory() {
        let dir = PRRadarPhasePaths.metadataDirectory(
            outputDir: "/output",
            prNumber: 42
        )
        #expect(dir == "/output/42/metadata")
    ...
    func analysisDirectory() {
        let dir = PRRadarPhasePaths.analysisDirectory(
            outputDir: "/output",
            prNumber: 42,
            commitHash: "abc1234"
        )
    ...
    func canRunFirstPhase() {
        let canRun = PRRadarPhasePaths.canRunPhase(
            .metadata,
    ...
    func validateCanRunError() {
        let error = PRRadarPhasePaths.validateCanRun(
            .prepare,
            outputDir: "/nonexistent",
            prNumber: 1
        )
    ...
    func phaseSubdirectory() {
        let dir = PRRadarPhasePaths.phaseSubdirectory(
            outputDir: "/output",
            prNumber: 42,
            phase: .prepare,
            subdirectory: PRRadarPhasePaths.prepareFocusAreasSubdir,
            commitHash: "abc1234"
        )
    ...
    func metadataIgnoresCommitHash() {
        // Act
        let withHash = PRRadarPhasePaths.phaseDirectory(
            outputDir: "/output", prNumber: 42, phase: .metadata, commitHash: "abc1234"
        )
        let withoutHash = PRRadarPhasePaths.phaseDirectory(
    ...
    func phaseExistsNonexistent() {
        // Act
        let exists = PRRadarPhasePaths.phaseExists(
    ...
    func phaseExistsIsolatesBetweenCommits() throws {
        ...
        // Act
        let existsA = PRRadarPhasePaths.phaseExists(
            outputDir: outputDir, prNumber: 1, phase: .diff, commitHash: "abc1234"
        )
        let existsB = PRRadarPhasePaths.phaseExists(
    ...
    func phaseStatusNotStarted() throws {
        ...
        // Act
        let status = PRRadarPhasePaths.phaseStatus(
    ...
    func allPhaseStatusesCommitScoped() throws {
        ...
        // Act
        let statuses = PRRadarPhasePaths.allPhaseStatuses(
    ...
    func allPhaseStatusesDifferentCommits() throws {
        ...
        // Act
        let statusesA = PRRadarPhasePaths.allPhaseStatuses(
            outputDir: outputDir, prNumber: 1, commitHash: "abc1234"
        )
        let statusesB = PRRadarPhasePaths.allPhaseStatuses(
    ...
    func canRunPhaseCommitScoped() throws {
        ...
        // Act
        let canRunPrepare = PRRadarPhasePaths.canRunPhase(
            .prepare, outputDir: outputDir, prNumber: 1, commitHash: "abc1234"
        )
        let canRunAnalyze = PRRadarPhasePaths.canRunPhase(
            .analyze, outputDir: outputDir, prNumber: 1, commitHash: "abc1234"
        )
